...
interface Props {
  ...
  /** 4 xonali kod kiritilganda chaqiriladi; xato bo'lsa throw qilishi kerak. */
...
export function TelegramConfirm({
  ...
  // 4 ta raqam kiritilsa — avtomatik tasdiqlash
  useEffect(() => {
    if (code.length === 4 && !verifyM.isPending) verifyM.mutate();
