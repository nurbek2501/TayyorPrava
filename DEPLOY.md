...
server {
    ...
    # Telegram kirish — redirect oqimi (iframe/tashqi skript YO'Q): foydalanuvchi
    # oauth.telegram.org ga o'tib, `#tgAuthResult=...` bilan qaytadi. Shu sabab
    # script-src/frame-src ga qo'shimcha manba kerak emas.
